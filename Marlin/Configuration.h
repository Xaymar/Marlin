...
#define MACHINE_UUID "d15662b0-fe9c-4fa5-9fbc-c507ab8c0c7d"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Anycubic Kossel with E3d - run 'M106 S255' & 'M303 E0 C8 S200'
  //#define  DEFAULT_Kp 30.16
  //#define  DEFAULT_Ki 2.54
  //#define  DEFAULT_Kd 89.56

  // Anycubic Kossel with E3d - run 'M106 S255' & 'M303 E0 C8 S250'
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Anycubic Kossel (for 90°C)
  //#define  DEFAULT_bedKp 705.98
  //#define  DEFAULT_bedKi 139.00
  //#define  DEFAULT_bedKd 896.42
  
  // Anycubic Kossel (for 60°C)
  //#define  DEFAULT_bedKp 400.09
  //#define  DEFAULT_bedKi 78.77
  //#define  DEFAULT_bedKd 508.02
  
  // Anycubic Kossel (for 90°C)
  #define  DEFAULT_bedKp 739.27
  #define  DEFAULT_bedKi 145.55
  #define  DEFAULT_bedKd 938.69
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define H_FACTOR 1.12
    #define R_FACTOR 2.62
    #define A_FACTOR 0.69
    // Above values from test on 16.07.2018
  ...
  #define DELTA_HEIGHT 297.20 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 134.55 //mm  Get this value from auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 96.0 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
// XYZ Jerk must be identical for Delta/Kossel style.
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -16.20  // Z offset: -below +above  [the nozzle]
// Anycubic Leveling Module v1:-18.0, v2:-14.9, v3: -16.15?
