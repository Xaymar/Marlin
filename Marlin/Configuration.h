...
#define DELTA
  ...
  #define DELTA_ENDSTOP_ADJ { 0.0, -1.62, -0.92 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 134.13 //mm  Get this value from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.38, -0.20, -0.18 } // get these values from auto calibrate
...
#define STRING_CONFIG_H_AUTHOR "Michael Fabian Dirks" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Anycubic Kossel Plus (90°C)
  #define  DEFAULT_bedKp 423.48
  #define  DEFAULT_bedKi 80.77
  #define  DEFAULT_bedKd 555.07
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.0, 80.0, 80.0, 96.0 }
#define DEFAULT_XYZ_STEPS_PER_UNIT 80.0
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 80.0 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -24.4 }
